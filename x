{
  ...
  "updated_at": "2019-02-08T17:00:23Z",
  "pushed_at": "2019-02-08T17:04:36Z",
  ...
  "size": 100813,
  "stargazers_count": 45114,
  "watchers_count": 45114,
  "language": "TypeScript",
  "has_issues": true,
  "has_projects": true,
  "has_downloads": true,
...
* set up jenkins ci
* write code for api
* figure out how to set up database in code
* figure out how to make db and use database dumps
* put repo names to the database
* make job to update the table
* make api to retreive from the tables
* set up db
